...
EGO_SUM=(
	...
	"github.com/nginxinc/nginx-plus-go-client v0.9.0/go.mod"
...
SRC_URI="https://github.com/nginxinc/nginx-prometheus-exporter/archive/${MY_PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
...
src_install() {
	...
	#fowners node_exporter:node_exporter /var/lib/${PN} /var/log/${PN}
}
